...
public class MediaLib
{
    public static void main(String [] args)
    {
        ...
        MediaFile.writeString(song3.getTitle() + delmiter + song3.getRating());
        MediaFile.writeString(song4.getTitle() + delmiter + song4.getRating());
        MediaFile.writeString(song5.getTitle() + delmiter + song5.getRating());
        MediaFile.writeString(song6.getTitle() + delmiter + song6.getRating());
        MediaFile.writeString(song7.getTitle() + delmiter + song7.getRating());
        MediaFile.writeString(song8.getTitle() + delmiter + song8.getRating());
